...
function App() {
  return (
    <div className="flex w-screen h-screen">
      ...
      <div className="h-full w-[85%] p-10 pt-[5%] flex flex-wrap overflow-hidden">
        ...
        <div className="p-3 border rounded shadow card w-[18%] h-[30vh] flex flex-col justify-center items-center">
          <div
            className="hover:scale-110 mb-3 w-full h-[80%] bg-contain bg-no-repeat bg-center"
            style={{
              backgroundImage:
